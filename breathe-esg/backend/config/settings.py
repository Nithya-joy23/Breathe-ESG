...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-j@7k2*2d7x*8aj*7d%cp$jjn-x@%0jml)kctle-+kftp#tbfm_')
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'ingestion.authentication.BearerTokenAuthentication',
        'ingestion.authentication.CsrfExemptSessionAuthentication',
    ],
